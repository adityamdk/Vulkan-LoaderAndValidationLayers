...
VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL vkGetInstanceProcAddr(VkInstance instance, const char* funcName)
{
    ...
    // EXT_debug_report
    if (instanceExtMap.size() != 0 && instanceExtMap[pTable].debug_report_enabled) {
    ...
    // KHR_XXX_surface
#ifdef VK_USE_PLATFORM_XCB_KHR
    if (instanceExtMap.size() != 0 && instanceExtMap[pTable].wsi_surf_xcb_enabled)
    {
...
#endif // VK_USE_PLATFORM_XLIB_KHR
#ifdef VK_USE_PLATFORM_MIR_KHR
    if (instanceExtMap.size() != 0 && instanceExtMap[pTable].wsi_surf_mir_enabled)
    {
...
#endif // VK_USE_PLATFORM_MIR_KHR
#ifdef VK_USE_PLATFORM_WAYLAND_KHR
    if (instanceExtMap.size() != 0 && instanceExtMap[pTable].wsi_surf_wayland_enabled)
    {
